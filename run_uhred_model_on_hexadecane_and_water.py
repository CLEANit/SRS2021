# -*- coding: utf-8 -*-
"""Run UHRED model on hexadecane and water.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/18Fujj29SGbnwFkYOPgs7UFXjiX4lrUYb
...
"""Input data are called "targer_data" and "noisy_data".

target_data is considered as the ground-truth which is used for comparision and recoared at a high input laser power.
noise_data is considered as the dataset that recorded while the input laser power kept low, which resulted to adding some noise to it.
"""

#Importing data, store it to a numpy array (target_data) and then print the shape of it. 
...
#Importing data, store it to a numpy array (noisy_data) and then print the shape of it.
noisy_data = read_tiff("/content/drive/My Drive/Data/2020-03-05 oil and water /Scan 2/20 mW/20 mW.tif") 
#printing size of the data file
print(noisy_data.shape)

"""Normalization and reshaping of the input (ground-truth and noisy input)"""
...
"""r_out_put is normalized in a way of having mean value of zero and standard deviation of 1."""
